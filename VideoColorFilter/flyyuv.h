...
public:
    ...
    static void ARGBToI420(unsigned char *src, unsigned char *dst, int width, int height);

    static void I420ToARGB(unsigned char *src, unsigned char *dst, int width, int height);

    static void RGB24ToI420(unsigned char *src, unsigned char *dst, int width, int height);
	...
	static void I420TO720P(unsigned char *i420, int f_width, int f_height);
